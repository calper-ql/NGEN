...
#define NGEN_OUTPUT(name) \
    ...
    public:
		...
		std::map<std::string, StringProperty*> string_properties;
		std::map<std::string, FloatProperty*> float_properties;
		std::map<std::string, SeedProperty*> seed_properties;
		std::map<std::string, IntProperty*> int_properties;
		std::map<std::string, BoolProperty*> bool_properties;
