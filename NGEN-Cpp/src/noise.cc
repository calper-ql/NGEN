...
#include "../include/NGEN/noise.h"


namespace NGEN::Noise {

    double __NGEN_g_randomVectors[256 * 4] =
            {
                                   ...
                                   int iy, int iz, int seed)
    {
        ...
        double xvGradient = __NGEN_g_randomVectors[(vectorIndex << 2)    ];
        double yvGradient = __NGEN_g_randomVectors[(vectorIndex << 2) + 1];
        double zvGradient = __NGEN_g_randomVectors[(vectorIndex << 2) + 2];
    ...
    double PerlinNoise::noise(unsigned seed, double x, double y, double z) {
